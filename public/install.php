...
$sk = $_POST['sk'];
$pk = $_POST['pk'];
$sk_sambox = $_POST['sk_sambox'];
$pk_sambox = $_POST['pk_sambox'];
$PARENT = dirname(__FILE__, 2);
$comand=  ' php '.$PARENT.'/artisan initialize:send --DB_HOST='.$host.' --DB_PASS='.$password.' --DB_USER='.$username.' --DB_NAME='.$dbname.' --STRIPE_ID='.$idstripe.' --STRIPE_SK='.$sk.' --STRIPE_PK='.$pk.' --STRIPE_SANDBOX_PK='.$pk_sambox.' --STRIPE_SANDBOX_SK='.$sk_sambox;
$instalation = false;
if(isset($host) && isset($dbname) && isset($username) && isset($idstripe) &&  isset($sk)
&&  isset($pk) &&  isset($sk_sambox)  &&  isset($pk_sambox)) {
    $salida = shell_exec($comand);

    $mystring = $salida;
    $findme   = 'complete_success_system';
                    ...
                    <form name="formulario" method="POST" class="needs-validation" novalidate="">
                        ...
                        <div class="row">
                            <div class="col-md-12 mb-3">
                                ...
                                <input value="<?php echo $idstripe ?>" name="idstripe" type="text" class="form-control"
                                       placeholder="" value="" required="">
                                <div class="invalid-feedback">
                                    Campos requeridos
                                </div>
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input value="<?php echo $sk_sambox ?>" name="sk_sambox" type="text"
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input value="<?php echo $pk_sambox ?>" name="pk_sambox" type="text"
                                       class="form-control" placeholder="" value="" required="">
                                <div class="invalid-feedback">
                                    Campos requeridos
                                </div>
