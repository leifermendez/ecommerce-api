...
?>
    ...
    <div class="container">
        <div class="py-5 text-center">
            ...
            <h2>INSTALACIÓN</h2>
            <p class="lead">Para que funcione tu Tienda online correctamente, te recomendamos llenar todos lo campos y verficar que cumples
...
<!--                        <strong>GD</strong>-->
<!--                        <span class="text-muted">--><?php //echo $gb ? 'Completo' : 'Error' ?><!--  Completo</span>-->
<!--                    </li>-->
            ...
            <div class="col-md-8 order-md-1">
                ...
                <form class="needs-validation" novalidate="">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            <label for="password">Password <span class="text-muted">(Vacio si no tienes clave)</span></label>
                    ...
                    <hr class="mb-4">
                    <button class="btn btn-primary btn-lg btn-block" type="submit">Continiar con la instalación</button>
                </form>
            </div>
        </div>
